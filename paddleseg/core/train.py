...
def train(model,
    ...
    while iter < iters:
        ...
        for data in loader:
            ...
            if hasattr(model, 'data_format') and model.data_format == 'NHWC':
                ...
                images2 = images.transpose((0, 2, 3, 1))
            ...
            if precision == 'fp16':
                with paddle.amp.auto_cast(
                    ...
                    logits_list = ddp_model(images,images2) if nranks > 1 else model(
                        images,images2)
                ...
                logits_list = ddp_model(images,images2) if nranks > 1 else model(images,images2)
    ...
    if local_rank == 0 and not (precision == 'fp16' and amp_level == 'O2'):
        ...
        _, c2, h2, w2 = images2.shape
        _ = paddle.flops(
            model, [1, c, h, w],[1, c2, h2, w2],
