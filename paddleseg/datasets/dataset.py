    ...
    def __init__(self,
        ...
        with open(file_path, 'r') as f:
            ...
            for line in f:
                ...
                self.file_list.append([image_path, image2_path,label_path])

    def __getitem__(self, idx):
        data = {}
        data['trans_info'] = []
        image_path, imge2_path, label_path = self.file_list[idx]
        # print ("idx",self.file_list[idx])
        # dict_keys(['trans_info', 'img', 'img2', 'label', 'gt_fields'])
        data['img'] = image_path
        data['img2'] = imge2_path
